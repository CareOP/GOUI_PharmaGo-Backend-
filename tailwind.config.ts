...
export default {
  // Use "class" strategy so Tailwind toggles when the 'dark' class is on the <html> tag
  darkMode: ["class"], 
  content: [
    "./index.html",
    "./pages/**/*.{ts,tsx}",
